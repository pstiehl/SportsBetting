...
_Generated: 2026-07-06T12:02:12.430839+00:00_

## TL;DR

- **13** (sport, source) pairs audited. **0** keep, **5** keep-with-caveats, **6** noise, **2** drop, **0** insufficient-data.
...
| wta | `coin-flip` | 4637 | +51.09% | 0.2500 | 0.6931 | -1.22% | -1.13 | $12,944 | 13 | **DROP** |
| wta | `market-close` | 4637 | +67.52% | 0.2013 | 0.5853 | -3.74% | -1.93 | $18,833 | 10 | **NOISE** |
| wta | `predict.tennis` | 3329 | +67.95% | — | — | -4.93% | — | — | — | **NOISE** |
| wta | `tennis-rank-bt` | 4625 | +63.44% | 0.2252 | 0.6415 | -4.09% | -6.77 | $20,219 | 7 | **NOISE** |
