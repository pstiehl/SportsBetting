...
_Generated: 2026-05-31T13:01:03.852144+00:00_

## TL;DR

- **18** (sport, source) pairs audited. **0** keep, **7** keep-with-caveats, **9** noise, **2** drop, **0** insufficient-data.
...
| atp | `sackmann-atp-elo` | 6951 | +64.36% | 0.2175 | 0.6242 | -3.21% | — | — | — | **NOISE** |
...
| wta | `sackmann-wta-elo` | 6587 | +63.29% | 0.2224 | 0.6354 | -4.66% | — | — | — | **NOISE** |
