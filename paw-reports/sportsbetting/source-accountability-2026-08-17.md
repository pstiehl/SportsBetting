...
_Generated: 2026-08-17T12:03:31.408895+00:00_

## TL;DR

- **17** (sport, source) pairs audited. **0** keep, **7** keep-with-caveats, **8** noise, **2** drop, **0** insufficient-data.
...
|---|---|---:|---:|---:|---:|---:|---:|---:|---:|---|
| atp | `coin-flip` | 5148 | +49.63% | 0.2500 | 0.6931 | -5.89% | -0.93 | $31,120 | 11 | **DROP** |
| atp | `market-close` | 8025 | +67.89% | 0.2013 | 0.5853 | -2.93% | -1.76 | $12,735 | 7 | **KEEP-WITH-CAVEATS** |
| atp | `market-consensus` | 8025 | +67.89% | 0.2013 | 0.5853 | -2.93% | — | — | — | **KEEP-WITH-CAVEATS** |
| atp | `predict.tennis` | 3430 | +67.11% | — | — | -2.36% | — | — | — | **KEEP-WITH-CAVEATS** |
| atp | `tennis-rank-bt` | 8025 | +63.29% | 0.2264 | 0.6450 | -4.18% | -5.74 | $14,901 | 8 | **NOISE** |
...
| wta | `coin-flip` | 4639 | +51.05% | 0.2500 | 0.6931 | -2.34% | -1.53 | $18,284 | 12 | **DROP** |
| wta | `market-close` | 7339 | +67.41% | 0.2041 | 0.5918 | -3.60% | -1.91 | $10,782 | 7 | **NOISE** |
| wta | `market-consensus` | 7339 | +67.41% | 0.2041 | 0.5918 | -3.60% | — | — | — | **NOISE** |
| wta | `predict.tennis` | 3329 | +67.95% | — | — | -4.93% | — | — | — | **NOISE** |
| wta | `tennis-rank-bt` | 7330 | +62.67% | 0.2281 | 0.6481 | -4.87% | -6.57 | $26,591 | 12 | **NOISE** |
